...
#ifndef MXSEGMENTEDCONTROL_SWIFT_H
#define MXSEGMENTEDCONTROL_SWIFT_H
...
@property (nonatomic) IBInspectable CGFloat segmentWidth;
...
@property (nonatomic) IBInspectable UIEdgeInsets segmentEdgeInsets;
...
@property (nonatomic) IBInspectable CGFloat separatorTop;
@property (nonatomic) IBInspectable CGFloat separatorBottom;
@property (nonatomic) IBInspectable CGFloat separatorWidth;
@property (nonatomic, strong) IBInspectable UIColor * _Nonnull separatorColor;
@property (nonatomic) IBInspectable CGFloat indicatorLeft;
@property (nonatomic) IBInspectable CGFloat indicatorRight;
...
@property (nonatomic, strong) IBInspectable UIColor * _Nullable boxColor;
@property (nonatomic) IBInspectable CGFloat boxOpacity;
@end
